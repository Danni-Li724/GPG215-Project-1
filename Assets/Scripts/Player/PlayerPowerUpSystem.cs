...
{ 
    ...
    public void ApplyFireStatusToEnemy(GameObject enemyGO)
    {
        ...
        FireEffect fx = Instantiate(
            fireballItem.fireEffectPrefab, null)?.GetComponent<FireEffect>();
    ...
    private IEnumerator ExpireAfter(PowerUpEffect effect, float seconds)
    {
        ...
        bool anyShooterEffect = activeEffects.Exists(
            e => e is TriShotEffect || e is RapidFireEffect || e is FireballEffect);
